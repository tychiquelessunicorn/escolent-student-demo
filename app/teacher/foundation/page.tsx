 ...
 * neutral chrome, color reserved for status meaning, no decorative illustration.
 */
      ...
      <div className="esc-staff-foundation-inner">
        <header className="esc-staff-foundation-header">
          ...
          <h1 className="esc-staff-foundation-title">
            Neutral, dense, and functional — color only when something matters.
          </h1>
          <p className="esc-staff-foundation-lede">
            Outfit and Plus Jakarta Sans stay for brand continuity, but headings run smaller
            and lighter than Student. Surfaces are cool neutrals. Escalation red is the first
            reserved semantic colour — not a general accent. No area rainbow, no achievement
            bursts, no illustration set.
          </p>
        </header>
